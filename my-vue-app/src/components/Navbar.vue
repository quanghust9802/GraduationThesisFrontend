  ...
  <nav class="flex items-center justify-between bg-blue-800 p-6 shadow-lg">
    ...
    <div class="ml-auto flex items-center space-x-6">
      ...
      <div @click="goToCart" class="relative cursor-pointer">
        <i class="pi pi-shopping-cart text-white text-3xl transition-transform duration-300 hover:scale-110"></i>
      </div>
      ...
      <router-link v-if="!user" to="/staff/login" class="text-blue-800 bg-white px-4 py-2 rounded hover:font-bold hover:shadow-lg transition duration-300">Đăng nhập</router-link>
    </div>
  </nav>
</template>
