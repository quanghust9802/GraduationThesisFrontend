    ...
    <div class="max-w-md w-full bg-white rounded-lg shadow-md p-8">
      ...
      <form @submit.prevent="handleRegister">
        <div class="mb-4">
          ...
          />
          <span v-if="$v.customerName.$error" class="text-red-500 text-sm">
            {{
              $v.customerName.required.$invalid
                ? "Vui lòng nhập họ và tên"
                : !$v.customerName.minLength.$invalid
        ...
        <div class="mb-4">
          <label for="cccdId" class="block text-sm font-medium text-gray-700"
            >CCCD</label
          >
          <input
            v-model="cccdId"
...
export default {
  ...
  validations: {
      customerName: { required, minLength: minLength(2) },
