...
export default {
  ...
  try {
    ...
    if (response.errCode === 200) {
      ...
      const tesst =  decoded['http://schemas.microsoft.com/ws/2008/06/identity/claims/role'];
      // Chuyển hướng theo role
      if(decoded['http://schemas.microsoft.com/ws/2008/06/identity/claims/role'] === 'Admin'){
        this.$router.push("/admin/user");
      }
       else if(decoded['http://schemas.microsoft.com/ws/2008/06/identity/claims/role'] === 'Employee'){
        this.$router.push("/employee/my-log");
      } else {
        this.$router.push("/"); 
      }
